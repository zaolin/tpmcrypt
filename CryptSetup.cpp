...
string CryptSetup::openVolume(string dev, string password)
{
	int ret = 1;
	list<string> args;
	list<string> stdout;
...
void CryptSetup::createVolume(string dev, string password, bool force,
...
void CryptSetup::changeVolume(string dev, string password, string newPassword) {
	list<string> args;
	list<string> stdout;
	int ret = 1;
	string stdin;
